...
### Docker Hub image
To use the Docker Hub image, follow the configuration steps 1 - 4, but first copy `docker-compose-dockerhub.yml` to `docker-compose.yml`. After configuration is complete, just run  
